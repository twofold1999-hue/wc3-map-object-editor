...
The toolbox now also includes reusable unit presets such as `boss` and `elite`, making it easier to apply common gameplay templates with a single command.
